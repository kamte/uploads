...
export declare type TypeaheadCompletion = ElementCompletion | AttributesCompletion | AttributeValuesCompletion;
...
export declare abstract class EditorService {
     ...
     */
    abstract getReferencesForFeatureAtPosition(localPath: string, position: SourcePosition): Promise<SourceRange[]>;
    /**
