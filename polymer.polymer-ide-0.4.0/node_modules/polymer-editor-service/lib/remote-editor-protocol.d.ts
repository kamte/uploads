...
export declare type Request = InitRequest | FileChangedRequest | GetWarningsRequest | GetDocumentationRequest | GetDefinitionRequest | GetReferencesRequest | GetTypeaheadCompletionsRequest | ClearCachesRequest;
